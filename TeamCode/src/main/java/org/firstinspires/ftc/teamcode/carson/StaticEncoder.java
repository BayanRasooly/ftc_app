...
public class StaticEncoder {
    ...
    public static void setRobot(Robot robot){
        StaticEncoder.robot = robot;
    }
    public static void setOp(LinearOpMode op){
        StaticEncoder.op = op;
    }


    public static void setLeftMotorPower(double speed){
        robot.left_motor.setPower(speed);
    }

    public static void setRightMotorPower(double speed){
        robot.right_motor.setPower(speed);
    }

    public static void setBothMotorPower(double speed){
        setLeftMotorPower(speed);
        setRightMotorPower(speed);
    }

    public static void encoderDrive(double speed, double left, double right, int time, Func<Boolean> func){
    ...
    public static void encoderDrive(double speed, double left,double right, int time){
    ...
    public static void encoderDrive(double speed, double left, double right){
        encoderDrive(speed,left,right,Integer.MAX_VALUE/2);
    }

    public static void encoderDrive(double speed, double distance){
