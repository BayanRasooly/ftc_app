...
@Autonomous(name="Crater Auto SAFE", group="Robot")
public class CraterAutoSAFE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //START SAFE
        en.encoderDrive(l_motor,r_motor,SPEED,5,5);//drive a tiny bit forward
        en.encoderDrive(l_motor,r_motor,SPEED,-5,5);//turn to a 45* angle
        en.encoderDrive(l_motor,r_motor,SPEED,100);//drive forward
        en.encoderDrive(l_motor,r_motor,SPEED,5,-5);//turn to claim
        en.align(l_motor,r_motor,left_distance,right_distance);
        //END SAFE
